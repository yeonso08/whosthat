...
**운영 상태**(2026-09-21): **두 번 거절당했다.** 2026-08-24 에 소유권 확인·검토 요청·GDPR 동의 메시지까지 끝냈고, 2026-09-02 에 "게시자 콘텐츠가 없는 화면에 Google 게재 광고" + "가치가 별로 없는 콘텐츠" 로 거절당했다. 같은 날 위 두 절대로 고쳐(광고를 페이지가 걸게 바꾸고, 소개·FAQ 산문을 세 언어로 넣었다) 재신청했다.
